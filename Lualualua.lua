...
local sitinklib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Minhnhatz/HopSever/main/Cainaylaui.lua"))()
...
CancelCoolDown = LPH_NO_VIRTUALIZE(function()
	...
	if ac and ac.equipped then
		AttackCoolDown = tick() + (FireCooldown or 0.255) + ((FireL / MaxFire) * 0.3)
		RigEven.FireServer(RigEven, "weaponChange", ac.currentWeaponModel.Name)
		FireL = FireL + 1
		task.delay((FireCooldown or 0.255) + ((FireL+0.4/MaxFire)*0.3),function()
			FireL = FireL - 1
		end)
	end
end)
